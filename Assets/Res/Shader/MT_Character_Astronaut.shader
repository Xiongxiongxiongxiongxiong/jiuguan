Shader "MT/MT_Character_Astronaut"
{
    Properties
    {
        [Header(Albedo)]
        ...
        _MaskRoughness ("Mask Roughtness", Range(0, 1)) = 1
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 _MainColor,_MaskColor;
            float _Roughness,_MaskRoughness;
            float _Metallic;
            float _AO;
            float _AnisoOffset;
            float4 _MainTex_ST;
            ...
            float _MainLightStrength,_specularStrength,_LightStrength_A,_LightStrength_B,_EnvLightLerp;
            ...
            half3 CalculateLight(v2f i, float3 lightDir, float3 lightCol, float3 albedo, float3 N, float3 V, float _RTex,float _MTex, float3 F0){
                ...
                //Color
                half3 PBRColor = albedo * BRDFinf * diffuseTerm + speculerCol * NdotL * _specularStrength;
            ...
            fixed4 frag(v2f i): SV_Target
            {
                ...
                //SSS
                #ifdef _SSSON_ON
                    half3 sss_mask = 1 -tex2D(_Thickness, i.uv);
