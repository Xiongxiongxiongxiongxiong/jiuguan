Shader "MT/MT_Character_Alpha"
{
    Properties
    {
        ...
        _RimColor_eye ("eye Rim Color", Color) = (1, 1, 1, 1)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float _SepcularStrength,_MainLightStrength,_LightStrength_A,_LightStrength_B,_EnvLight_Lerp;
            ...
            fixed4 frag(v2f i): SV_Target
            {
                ...
                half4 finalCol = half4(col, albedo.a);
