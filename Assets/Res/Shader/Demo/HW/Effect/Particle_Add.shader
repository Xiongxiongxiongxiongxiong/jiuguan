    ...
    SubShader {
        ...
        Pass {
            ...
            fixed4 frag(VertexOutput i) : COLOR {
                ...
                float4 _Diffuse_var = tex2D(_MainTex,TRANSFORM_TEX((mul(i.uv0-float2(0.5,0.5),float2x2( i_cos, -i_sin, i_sin, i_cos))+float2(0.5,0.5)), _MainTex)) * _Color;
